...
import type { OfficialContest } from "@/lib/official-contests";

type OfficialContestCardProps = Pick<
  OfficialContest,
  "title" | "url" | "description"
>;

export function OfficialContestCard({
  title,
  url,
  description,
}: OfficialContestCardProps) {
  return (
    <ExternalLink
      href={url}
      ...
      aria-label={`View past ${title} contests (opens in a new tab)`}
    >
